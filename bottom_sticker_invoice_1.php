...
<page style="font-size:11px; font-family: Arial" backtop="2mm" backbottom="65mm" backleft="5mm" backright="5mm">

    <?php //if(tep_db_num_rows($eparcel_qry) > 0) { ?>
    
	<!-- eParcel Label Page Start-->
	<page_footer style="font-size:11px; font-family: Arial;">
	...
	<table align="center" style='width: 100%; border: solid 1px #EFEFEF;' cellspacing='0' cellpadding='0'>
	   <tr>
		<td style='width: 100%; vertical-align:top; height:190px;'>
		 <?php 
			//if(sizeof($order->products)>8) { $product_area_ht = "600px"; }
			//else { $product_area_ht = "193px"; }	
		 ?>
		 <!--<div style='width: 100%; height:160px; vertical-align:top; overflow:scroll;'> <!-- with Overflow -->
