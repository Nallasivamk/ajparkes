...
<page style="font-size:11px; font-family: Arial;" backleft="5mm" backright="5mm">  
	...
	&nbsp;</div>
		...
		<page_footer style="font-size:11px;">
			...
			<table style="width:100%" cellspacing="0" cellpadding="0">            
				<tr>
					<td style="width: 60%; vertical-align:top;line-height:13px;">                
							...
							<?php 
								if(tep_db_num_rows($eparcel_qry) > 0) { 
									...
									if (preg_match("/express/i", $order->info["shipping_method"])) {
										echo '<img src="images/eparcel_express.JPG" style="width:270px; height:68px;">';
										
									} else {
										echo '<img src="images/eparcel_aus.jpg" style="width:270px; height:68px;">';										
									}													
								} else {
							...
							<div style="padding:2px;">
								<?php 
									...
									if(!empty($orders_arr["delivery_suburb"])) {
										echo $orders_arr["delivery_suburb"]."<br>";
									}
									echo $orders_arr["delivery_city"].", " .
							...
							<div style="vertical-align: middle;text-align: center; border: 1px solid #000; border-radius: 1mm; background: #EFEFEF; border-collapse: collapse; padding:1mm; margin-top:3px;">
					...
					<td style="width: 40%; vertical-align:top;line-height:13px;">             
						<div style="padding:2px; text-align:right;">
								...
								<b>Sender</b>: AJ Parkes & Co Pty Ltd<BR />
								PO Box 234<BR />
				...
				<tr>
					<td colspan="2" style="width:100%; text-align:center; border-bottom:1px solid #000;"> 
						
					  <?php if(tep_db_num_rows($eparcel_qry) > 0) { 
							
							echo '<br><br>Consignment number: '.$eparcel_arr["consignment_number"];
				...
				<tr>
					<td colspan="2" style="width:100%; font-size:9px; text-align:justify;line-height:13px; padding-top:5px;"> 
						<?php if(tep_db_num_rows($eparcel_qry) > 0) { ?>
