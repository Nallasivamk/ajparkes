...
if (!@$_POST['action']) {
  ...
  $submit_accountant_email_to_xero = (isset((int)$_POST['submit_accountant_email_to_xero']) ? tep_db_prepare_input((int)$_POST['submit_accountant_email_to_xero']) : '');
...
<?php
	...
	//log activities		
	tep_update_admin_activities(3,"","New account# ".$customer_id." created.");
