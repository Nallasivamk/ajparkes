...
$progressing_orders = array();
$progressing_orders = $admin->get_admin_progressing_orders($current_admin_id);

//print_r($progressing_orders);
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="data-table">
		...
		foreach($progressing_orders as $key=>$val) {
