...
<?php 
							...
							<table border="0" width="100%" cellspacing="0" cellpadding="2">
								<tr>
									<td style="width:50%; text-align:left; vertical-align:middle;">
										<img src="images/loaded_header_logo_small.png" style="border:none;" border='0'>
									</td>
	...
	<div style="z-index:-1; width:100%; height:300px; <?php echo $paid_watermark; ?>">
		...
		?>
			...
			<tr>
			  <td colspan="3" style="width:56%; text-align:center;">
						<?php
              ...
              <td colspan="3" style="width:44%; text-align:right;">
	...
	&nbsp;</div>
		...
		<table align="left" style="width:100%; vertical-align:bottom;"  cellspacing="0" cellpadding="0">
		 <tr>
			...
			<table style="width:100%" cellspacing="0" cellpadding="0">            
				...
				<tr>
					<td style="width:100%; text-align:center;line-height:14px;font-size:11px;">					
						<br />
						AJ Parkes & Co Pty Ltd - Badges, Medallions, Trophies, Awards and Plastic Injection Moulding<br />
						<b>Free Call: </b> 1800 777 125<br />
						(Australia Only)<br />
						<b>PH: </b> +617 3277 2111<br />
						<b>Fax: </b> +617 3054 1912<br />
						PO Box 234 - Salisbury, QLD 4107, Australia<br />
		  ...
		  <td style="width:65%; padding:5px 25px 5px 10px; vertical-align:top;">
			<!-- NEW FORMAT -->
			<table style="width: 100%;" cellspacing="0" cellpadding="0">            
				<tr>
					<td style="width: 59%; vertical-align:top;">                
							<?php 
								if(tep_db_num_rows($eparcel_qry) > 0) { 
									...
									if (preg_match("/express/i", $order->info["shipping_method"])) {
										echo '<img src="images/eparcel_express.JPG" style="width:250px; height:68px;">';
										
									} else {
										echo '<img src="images/eparcel_aus.jpg" style="width:250px; height:68px;">';										
									}													
								} else {
					...
					<td style="width: 29%; vertical-align:center;">             
						<div style="padding:2px; text-align:left;font-size:11px;">
								<br/>PHONE: <?php echo $order->customer['telephone']; ?>
						</div>                  
					</td>					
					<td style="width: 12%; vertical-align:center;">             
						<div style="text-align:left;">
								<br/><datamatrix value="<?php echo $eparcel_arr["barcode_number"]; ?>" style="border: none; width: 13.86mm;"></datamatrix>								                       
						</div>                  
					</td>
				</tr>
			</table>
			...
			<table style="width: 100%; padding:5%;" cellspacing="0" cellpadding="0">
				<tr>
					<td style="width:70%; font-size:12px; padding:5px; border-top:1px solid #CCC;">
						<b>DELIVERY INSTRUCTIONS</b><br/>
					</td>
					<td style="text-align:right; padding:5px; font-size:12px; border-top:1px solid #CCC;">
							<b><?php 
				...
				<tr>
					<td style="width:70%; font-size:12px; padding:5px; border-top: solid 1px #CCC;">
					...
					<td style="border-top: solid 1px #CCC; border-left: solid 1px #CCC; padding:5px;font-size:11px;">
						<?php if(tep_db_num_rows($eparcel_qry) > 0) { 
				...
				<tr>
					<td style="width:100%; text-align:center; padding:5px; font-size:11px; border-top:1px solid #CCC;" colspan="2">
						<?php if(tep_db_num_rows($eparcel_qry) > 0) { 
							...
							if(!empty($eparcel_arr["consignment_number"]) && !empty($eparcel_arr["article_number"]) && !empty($eparcel_arr["barcode_number"])) {
								...
								if(file_exists("./eParcel/barcode/".$eparcel_arr["article_number"].".gif")) {
									echo '<br><img src="./eParcel/barcode/'.$eparcel_arr["article_number"].'.gif" style="width:300px; height:80px;" />';
								}
							} 
			...
			<table style='width: 100%; border-top:1px solid #CCC;' cellspacing='0' cellpadding='0'>
				<tr>
					<td style="width:39%; padding:5px;font-size:11px;"> 
						<b>SENDER</b><br>
					...
					<td style='width:60%; text-align:justify; font-size:9px; padding:5px; border-left: solid 1px #CCC;'>        
