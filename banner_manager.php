  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      case 'update':
        ...
        //Modified to store both HTML and images - July 06 2011
...
echo tep_insert_html_editor('banners_html_text','advanced','500');
?>
          ...
          <tr>
            ...
            <td class="main">
				<?php 
					...
					echo tep_draw_textarea_field('banners_html_text', 'soft', '100%', '20', $bInfo->banners_html_text,' style="width: 100%" mce_editable="true"');
				?>
			</td>
          </tr>
          <tr>
